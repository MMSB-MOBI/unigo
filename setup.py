...
setup(
    ...
    # project.
    author='G.Launay',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='guillaume.launay@ibcp.fr',  # Optional
    ...
    # larger catalog.
    keywords='uniprot, GO, ontology',  # Optional
    ...
    install_requires=['requires', 'pyproteinsExt'],  # Optional
   ...
   # data_files=[('vehicule_speed', ['data/speed.dat'])],  # Optional
